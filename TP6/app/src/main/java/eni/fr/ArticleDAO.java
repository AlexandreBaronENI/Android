...
public class ArticleDAO {
    ...
    public ArrayList<Article> get(boolean tri)
    {
        ...
        android.database.Cursor curseur = db.query(ArticleContract.TABLE_NAME, ArticleContract.ALL_COLUMN, null, null, null, null, orderBy);
    ...
    public Article get(int id)
    {
        ...
        android.database.Cursor curseur = db.query(ArticleContract.TABLE_NAME, ArticleContract.ALL_COLUMN, ArticleContract._ID+" == ?", new String[]{Integer.toString(id)}, null, null, null);
